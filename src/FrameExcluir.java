...
public class FrameExcluir extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel17.setText("Excluir Usuário");
        ...
        jLabel18.setText("Informe o UserID para localizar e excluir o cadastro.");
        jPanel5.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, -1, -1));

        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/EMOJI CABEÇALHO EXCLUIR.png"))); // NOI18N
        ...
        jPanel3.setBackground(new java.awt.Color(247, 238, 245));
        jPanel3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(216, 192, 209)));
        ...
        jLabel7.setText("Dados do usuário");

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/perfil jdf(1).png"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PERFIL ESQUERDO EXCLUIR (1).png"))); // NOI18N
        ...
        jPanel4.setBackground(new java.awt.Color(239, 231, 234));
        jPanel4.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(134, 74, 107)));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel10.setText("desfeita.");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel2.setText("permanente e não poderá ser ");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel1.setText("A exclusão deste usuário é ");

        jLabel23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/EMOJI AVISO EXCLUIR.png"))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // BOTAO EXCLUIR
            ...
            int Resposta;
            Resposta = showConfirmDialog(null, "Deseja realmente excluir este usuário?" + "\n" + "Essa ação não poderá ser desfeita.", "Confirmação",0,2);
            ...
            int Linhas=stmt.executeUpdate("delete from usuarios where codigo='" + UserId +"'"); 

            if (Linhas!=0)  

            showMessageDialog(this,"Registro excluído com sucesso"); 

            else 

            showMessageDialog(this,"Registro não excluído"); 
            ...
            showMessageDialog(null, "Exclusão cancelada.", "Registro não excluído", 1);
           }
